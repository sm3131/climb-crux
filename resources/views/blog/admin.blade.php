...
<div class="grid grid-cols-1 justify-items-center gap-6 font-roboto mt-4 sm:mt-14 mx-2 sm:mx-16">
    <h3 class="text-2xl text-center">Climb Crux Conquer Admin Blog</h3>
    @if(empty($blogs))
...
<div class="flex mt-2 justify-center gap-4">
    <a class="border border-grey bg-white hover:bg-grey rounded font-roboto px-2" href="/blog-create">Create New Blog</a>
...
<div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 justify-items-center gap-4 sm:gap-10 font-aleg tracking-wide mt-10 mx-2 sm:mx-12 sm:mb-10">
    ...
    <div>
        ...
        <div class="mb-4 sm:mb-0">
            <a href="/blog-edit/{{$blog->id}}" class="border border-dark-grey p-2 rounded-md hover:bg-dark-grey bg-white">Edit Post</a>
        </div>
    </div>
    @endforeach
</div>
